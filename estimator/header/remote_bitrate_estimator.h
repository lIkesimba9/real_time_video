...
void rbe_incoming_packet(remote_bitrate_estimator_t *est, uint32_t timestamp,
                         int64_t arrival_ts, size_t payload_size,
                         int64_t now_ts);

int rbe_heartbeat(remote_bitrate_estimator_t *est, int64_t now_ts,
                  uint32_t *remb);
